...
\begin{tikzpicture}
	...
	\draw (S-5-1.south west) -- (S-5-8.south east);
	\foreach \i in{1,...,8}{
		...
		\node at (S-2-1) {\(x-1\)};
		\node at (S-3-1) {\(4-x^2\)};
		\node at (S-4-1) {\(x^2-4x+6\)};
		\node at (S-5-1) {\(\left(x-1\right)\left(4-x^2\right)\left(x^2-4x+6\right)\)};
		\node at (S-2-2) {\(-\)};
		\node at (S-2-3) {\(-\)};
		\node at (S-2-4) {\(-\)};
		\node at (S-2-5) {\(0\)};
	...
	\draw[top color=red, fill opacity=.2, decorate,decoration={brace,mirror,amplitude=1.5mm}](S-5-3.south west) to node[midway,fill opacity=1,below]{Decrescente} (S-5-5.south east);
	\draw[top color=red, fill opacity=.2, decorate,decoration={brace,mirror,amplitude=1.5mm}](S-5-7.south west) to node[midway,fill opacity=1,below]{Decrescente} (S-5-8.south east);
\end{tikzpicture}
