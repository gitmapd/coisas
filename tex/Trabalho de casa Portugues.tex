	...
	\begin{tikzpicture} 
		\node[rectangle, thick, dotted, draw=blue] (a) at (0,0) {\parbox{50cm}{
				\begin{itemize}
					...
					Vou passar o fim de semana na praia, \textbracketred{a não ser que}{concessiva} chova muito.
					...
					Tenho de decorar o meu papel, \textbracketred{de modo a que}{consecutiva} a peça corra bem.
...
\begin{tikzpicture} 
	\node[rectangle, thick, dotted, draw=blue] (a) at (0,0) {\parbox{50cm}{
			\begin{itemize}
				...
				\textbracketgreen{O Diogo está ciente da resposta certa}{Subordinante}, \textbracketred{embora não corrigiu o amigo.}{Oração Subordinada Adverbial Concessiva}
